class v{constructor(){this._canvas=null,this.gameInstance=null,this.currentMenu="main",this.settings={soundVolume:.7,musicVolume:.5,haptics:!0,colorblind:!1,highContrast:!1,leftHandMode:!1,motionReduced:!1,screenShake:!0,rhythmAssist:!0},this.cosmetics=[{id:"basic_collar",name:"Basic Collar",type:"collar",unlocked:!0,equipped:!0},{id:"golden_collar",name:"Golden Collar",type:"collar",unlocked:!1,equipped:!1},{id:"sparkle_trail",name:"Sparkle Trail",type:"trail",unlocked:!1,equipped:!1},{id:"beat_wings",name:"Beat Wings",type:"hat",unlocked:!1,equipped:!1},{id:"happy_bark",name:"Happy Bark",type:"emote",unlocked:!1,equipped:!1}],this.toasts=[];const e=document.getElementById("uiOverlay");if(e)this.overlay=e;else{console.error("uiOverlay element not found!");const t=document.createElement("div");t.id="uiOverlay",t.className="ui-overlay",document.body.appendChild(t),this.overlay=t}this.setupEventListeners(),this.loadSettings(),console.log("UIManager initialized with overlay:",this.overlay)}initialize(e,t){this._canvas=e,this.gameInstance=t,this.createMainMenu()}setupEventListeners(){window.addEventListener("resize",()=>{this.handleResize()}),document.addEventListener("keydown",e=>{this.handleKeyboardShortcuts(e)}),"share"in navigator&&this.setupWebShare()}handleResize(){const e=window.innerWidth<768;this.overlay.classList.toggle("mobile-layout",e),this.settings.leftHandMode&&this.overlay.classList.add("left-hand-mode")}handleKeyboardShortcuts(e){if(e.code==="Escape"&&this.currentMenu!=="main"&&this.showMenu(),e.code==="KeyS"&&e.ctrlKey&&(e.preventDefault(),this.showSettings()),e.code==="KeyL"&&e.ctrlKey&&(e.preventDefault(),this.showLeaderboard()),(e.code==="ArrowDown"||e.code==="ArrowUp")&&this.handleArrowKeyNavigation(e.code==="ArrowDown"?1:-1),e.code==="Enter"||e.code==="Space"){const t=document.activeElement;t&&t.tagName==="BUTTON"&&t.click()}}handleArrowKeyNavigation(e){const t=this.overlay.querySelectorAll('button:not(:disabled), [href], input, select, textarea, [tabindex]:not([tabindex="-1"])');if(t.length===0)return;let a=Array.from(t).indexOf(document.activeElement)+e;a<0&&(a=t.length-1),a>=t.length&&(a=0),t[a].focus()}showMenu(){console.log("showMenu called"),console.log("overlay element:",this.overlay),this.currentMenu="main";try{const e=this.createMainMenuHTML();console.log("Created menu HTML, length:",e.length),this.overlay.innerHTML=e,console.log("Set overlay innerHTML"),this.bindMainMenuEvents(),console.log("Bound menu events"),this.overlay.classList.remove("hidden"),console.log("Removed hidden class from overlay"),this.overlay.style.display="block",this.overlay.style.visibility="visible",this.overlay.style.opacity="1",console.log("Applied inline styles to ensure visibility")}catch(e){console.error("Error in showMenu:",e)}}createMainMenu(){this.showMenu()}createMainMenuHTML(){const e=this.settings.leftHandMode?"left-hand-mode":"",t=this.settings.highContrast?"high-contrast":"",s=this.settings.colorblind?"colorblind-safe":"";return`
